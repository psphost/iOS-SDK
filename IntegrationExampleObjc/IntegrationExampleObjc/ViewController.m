...
@property (nonatomic, strong) JetpayHostsSDK *sdkFacade;
@end
...
- (void)viewDidLoad {
    ...
    // Init SDK
    self.sdkFacade = [[JetpayHostsSDK alloc] init];
    ...
    [self.sdkFacade presentPaymentAt:self paymentInfo:paymentInfo completionHandler:^(JetpayHostsPaymentResult *result) {
